...
function WebsiteTechBanner() {
    return (
        <section className="w-full mx-auto my-6 sm:my-16 px-2">
            <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between px-2 sm:px-8">
                ...
                {/* RIGHT SIDE IMAGE */}
                <div className="flex justify-center sm:justify-end sm:mt-0 mt-12">
                    <Image
                        src="/assist/website-img.webp"
                        alt="Website & Tech"
                        width={500}
                        height={500}
...
export default WebsiteTechBanner