...
const LogoandBrand = () => {
    ...
    const digitalCards = [
        ...
        { src: "/assist/logo-design-brand.svg", text: features[1] },
        { src: "/assist/stationery-desing-brand.svg", text: features[2] },
    ];
                ...
                <div className="w-full -mt-18 sm:-mt-22 px-3 sm:px-8 pl-0 sm:pl-10 text-left text-black relative z-20">
                    ...
                    <div className="space-y-8 px-2 sm:px-0">
                        ...
                        <p className="text-[16px] sm:text-[20px] font-[600] text-black mb-6">
                            Brand identity building is complex, but we can help you start with a few key things:
                        </p>
                    </div>
