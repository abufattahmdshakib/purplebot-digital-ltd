...
const Merchandise = () => {
    const features = [
        { src: "/assist/branded.gift-merchandise.svg", text: "Branded Apparel Design" },
        { src: "/assist/corporate.gift-merchandise.svg", text: "Corporate Gifts Design" },
        { src: "/assist/promotional.gift-merchandise.svg", text: "Promotional Merchandise Design" },
        { src: "/assist/event.gift-merchandise.svg", text: "Event Giveaways Designs" },
        { src: "/assist/personalised.gift-merchandise.svg", text: "Personalised Packaging Design" },
    ];
        ...
        <section className="px-2 mt-0  relative py-8 z-10 overflow-hidden">
            ...
            <div className="shape-wrapper-services-reverse left-0 sm:left-70 relative flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="relative w-full sm:w-2/5 flex justify-center items-end -mt-8 sm:mt-6 z-10 overflow-visible">
                    <div className="relative z-20 flex justify-center right-[-16px] sm:right-16 w-full mx-auto pointer-events-none">
                        <Image
                            src="/assist/gift-merchandise.webp"
                ...
                <div className="w-full sm:-mt-16 -mt-12 mb-2 sm:mb-6 sm:w-[65%] px-2 sm:px-0 relative sm:left-[-44px] z-20">
                    ...
                    <div className="space-y-8 text-center sm:text-left px-2 sm:px-0 pr-0 sm:pr-4">
                        <p className="font-[400] text-[16px] sm:text-[20px] text-black mb-4">
                            Our team excels at designing unique, high-quality products that your customers and clients will love.
                        </p>

                        <p className="text-[16px] sm:text-[20px] font-[400] text-black mb-3">
                            From concept development to final production, we ensure every item reflects your brand’s identity and values, turning everyday objects into memorable brand ambassadors.
                        </p>

                        <p className="text-[16px] sm:text-[20px] font-[600] text-black mb-3">
                            Services we offer under Gift & Merchandise:
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full sm:w-3/5 sm:ml-auto mt-0 sm:-mt-48 sm:pr-20 grid grid-cols-2 sm:flex sm:flex-wrap justify-center sm:justify-end gap-2">
                {features.map((card, i) => (
