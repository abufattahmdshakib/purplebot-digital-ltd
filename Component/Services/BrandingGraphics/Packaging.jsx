...
const Packaging = () => {
    const features = [
        ...
        "Label Design",
        "Delivery Bag / Box Design",
    ];

    const digitalCards = [
        { src: "/assist/core.packaging.svg", text: features[0] },
        { src: "/assist/label.packaging.svg", text: features[1] },
        { src: "/assist/delivery.packaging.svg", text: features[2] },
    ];
                ...
                <div className="w-full -mt-18 sm:-mt-22 px-3 sm:px-8 pl-0 sm:pl-10 text-left text-black relative z-20">
                    ...
                    <div className="space-y-8 px-2 sm:px-0">
                        ...
                        <p className="text-[16px] sm:text-[20px] font-[600] text-black mb-6">
                            Services we offer under Packaging Design:
                        </p>
                    </div>
