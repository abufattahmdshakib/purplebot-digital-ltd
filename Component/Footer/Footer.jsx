...
function Footer() {
    return (
        <footer className="bg-black text-white pt-8 pb-4 md:pb-18 font-poppins">
            <div className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
